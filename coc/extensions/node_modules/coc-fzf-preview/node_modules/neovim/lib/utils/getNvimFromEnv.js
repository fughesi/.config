...
exports.exportsForTesting = exports.getNvimFromEnv = void 0;
 ...
 */
function getNvimFromEnv(opt = {}) {
    const paths = process.env.PATH.split(node_path_1.delimiter);
    const pathLength = paths.length;
    const matches = new Array();
    const invalid = new Array();
    for (let i = 0; i !== pathLength; i = i + 1) {
        const possibleNvimPath = (0, node_path_1.join)(paths[i], windows ? 'nvim.exe' : 'nvim');
        if ((0, node_fs_1.existsSync)(possibleNvimPath)) {
            try {
                (0, node_fs_1.accessSync)(possibleNvimPath, node_fs_1.constants.X_OK);
                const nvimVersionFull = (0, node_child_process_1.execSync)(`${possibleNvimPath} --version`).toString();
...
exports.getNvimFromEnv = getNvimFromEnv;
